...
<p>
    The <b>RIGHT JOIN</b> keyword returns <b>all records from the right table</b> 
    and the <b>matched records from the left table</b>.
    If there is no match, the result will contain <b>NULL values</b> from the left table.
</p>

<div class="mascot-container">
    <div class="dolphin-mascot">🐬</div>
    <div class="chat-bubble">
        "👉 <strong>RIGHT SIDE ROYALTY!</strong> 👉 <br>
        RIGHT JOIN always supports the right table 👑 <br>
        No match on the left? No problem 😎 <br>
        It still shows up… just with NULL on the left side! 🔥"
    </div>
</div>

<p>
    RIGHT JOIN is used to: <br>
    ✔ Get all data from the right table <br>
    ✔ Include matching data from the left table <br>
    ✔ Find missing data from the left side
</p>
...
<div class="sql-result-table">
    <h4>emp_details Table (RIGHT TABLE)</h4>
    <table>
        <tr>
            <th>emp_id</th>
            <th>department</th>
...
<p>
    ⚡ Notice: emp_id = 3 is shown even though it doesn't exist in Employees.  
...
<div class="assignment-box">
    ...
    <p>Show all courses even if no student is enrolled.</p>

    <div class="task">
        ➤ Display course name and student name <br>
        ➤ Show ALL courses (RIGHT table)
    </div>
    ...
    <div class="sql-result-table">
        <table>
            ...
            <tr><td>101</td><td>SQL</td></tr>
            <tr><td>102</td><td>Python</td></tr>
        </table>
    </div>
...
<div class="assignment-box">
    ...
    <h3>Complete Department Report</h3>

    <p>
        Use RIGHT JOIN to show ALL departments, even if no employee exists.
    </p>

    <div class="task">
        ➤ Display: emp_id, name, department, salary <br>
        ➤ Show ALL departments <br>
        ➤ Missing employee data should be NULL
    </div>
    ...
    <div class="sql-result-table">
        ...
        <table>
            ...
            <tr><td>1</td><td>HR</td><td>40000</td></tr>
