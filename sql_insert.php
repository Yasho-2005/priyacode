...
INSERT is a <b>Data Manipulation Language (DML)</b> command because it deals with adding data,
    ...
    <div class="chat-bubble" style="border-color: #2ecc71; box-shadow: 0 0 15px rgba(46, 204, 113, 0.5);">
        "YAY! It's dinner time for the database! 🍔🐬 <br>
        Using <strong>INSERT INTO</strong> is how we actually put the data fish inside our tables. <br>
        Make sure the <strong>VALUES</strong> match the columns exactly, or the database will spit it back out! Stay iconic! 💅✨"
    </div>
</div>
...
<div class="mini-quiz-section">
    <h4>🍔 The Feeding Challenge: Fill the Table!</h4>

    <div class="quiz-item">
        <p>1. Which keyword comes immediately after the table name in an INSERT command?</p>
        <input type="text" id="q1" placeholder="Type keyword...">
    </div>

    <div class="quiz-item">
        <p>2. If I want to add data into 'students', I write: INSERT INTO _______?</p>
        <input type="text" id="q2" placeholder="Type table name...">
    </div>
    ...
    fields.forEach(field => {
        ...
        if (val !== field.ans) {
            input.style.border = "3px solid #ff4d4d"; // High-visibility red border
            allCorrect = false;
        } else {
            input.style.border = "2px solid #2ecc71"; // Green for Insert success
        }
    });

    if (allCorrect) {
        feedback.style.color = "#2ecc71";
        feedback.innerHTML = "✔ SLAY! The database is full and happy. Proceeding...";
        return true; 
    } else {
        event.preventDefault(); 
        feedback.style.color = "#ff4d4d";
        feedback.innerHTML = "❌ WAIT! The data fish escaped! Fix the red borders.";
